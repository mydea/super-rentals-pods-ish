...
![About page](/screenshots/02-building-pages/about@2x.png)
...
![Contact page](/screenshots/02-building-pages/contact@2x.png)
...
```handlebars { data-filename="app/pods/index/template.hbs" data-diff="+5" }
<div class="jumbo">
  <div class="right tomster"></div>
...
![Index page after adding the link](/screenshots/02-building-pages/index-with-link@2x.png)

![About page after adding the link](/screenshots/02-building-pages/about-with-link@2x.png)

![Contact page after adding the link](/screenshots/02-building-pages/contact-with-link@2x.png)
