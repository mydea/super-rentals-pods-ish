...
![All tests passing](/screenshots/03-automated-testing/pass@2x.png)
...
![A failing test](/screenshots/03-automated-testing/fail@2x.png)
...
![Tests still passing with the new tests](/screenshots/03-automated-testing/pass-2@2x.png)
